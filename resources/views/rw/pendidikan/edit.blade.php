...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('rw.pendidikan.update', $pendidikan->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('kelurahan') is-invalid @enderror" name="kelurahan" required>
                        ...
                        <option value="Kelurahan Kesambi" {{ $pendidikan->kelurahan == 'Kelurahan Kesambi' ? 'selected' : '' }}>Kelurahan Kesambi</option>
                        <option value="Kelurahan Drajat" {{ $pendidikan->kelurahan == 'Kelurahan Drajat' ? 'selected' : '' }}>Kelurahan Drajat</option>
                        <option value="Kelurahan Pekiringan" {{ $pendidikan->kelurahan == 'Kelurahan Pekiringan' ? 'selected' : '' }}>Kelurahan Pekiringan</option>
                        <option value="Kelurahan Sunyaragi" {{ $pendidikan->kelurahan == 'Kelurahan Sunyaragi' ? 'selected' : '' }}>Kelurahan Sunyaragi</option>
                        <option value="Kelurahan Karyamulya" {{ $pendidikan->kelurahan == 'Kelurahan Karyamulya' ? 'selected' : '' }}>Kelurahan Karyamulya</option>
                    </select>
                    @error('kelurahan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
